...
每个操作系统都应该有这一部分，完成双击前运行的准备。

### challenge2：一些小问题

为什么程序的链接地址和加载地址要统一？

因为在编译和链接的时候确定，`Store`指令中的地址不会再发生变化，因此程序的加载地震局不能改变，或者需要调整`addressA`。

### challenge3：中断相关

## 心得体会

这次实验我们窥探到了操作系统的独到之处。通过上电这个简单的操作，逐渐对ucore这个简单的操作系统有了些许的体会。后面我们会继续完成后面的实验
